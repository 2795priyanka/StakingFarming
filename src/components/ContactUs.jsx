            ...
            <Container className='py-4'>
                <Row>
                    <Col lg={12}>
                        ...
                        <div className="text">Are you a project owner and interested on listing on GoStake ?</div>
                    </Col>
                </Row>
               ...
               <Row className='justify-content-center'>
                    ...
                    <Col lg={6} md={6}>
                       <div className="contact_form">
                          ...
                          <div className="send_btn d-grid mb-3 mt-5">
                              <button className='btn send py-2'>SEND</button>
                          </div>
                       </div>
                    </Col>
                </Row>
