...
// const [Unlock_OneMonth, setUnlock_OneMonth] = useState("0%")
                ...
                <div className="staking_section">
                    <Container>
                        <Row className='justify-content-center'>
                            <Col lg={6} md={7}>
                                <div className="staking_title">Stake (GoStake)</div>
                        ...
                        <Row className='justify-content-center mt-4'>
                            <Col lg={6} md={7}>
                                <div className="head">
                                    ...
                                    <div className="view_bscScan"><a href="https://testnet.bscscan.com/address/0x1514bce9322de1ef85461f835d017f631dfe08ed" target="_blank">View on BSCscan</a></div>
                                </div>
                                <div className="statistics_container">
                                    <div className="token_details">
                                        ...
                                        <div className="token1">
                                            <div className='left_div'>Total staked with Token 1</div>
